...
const FREE_MODIFIER_OPTION_IDS = {
  ...
  // Sustitución de carne (ternera -> pollo, un solo sentido, gratis).
  // Opción "Cambiar ternera por pollo" del grupo "MODIFICACIONES" en Loyverse.
  cambiar_ternera_por_pollo: '2c8c300d-6b4a-4818-9947-4987a715548f',
  sustituir_ternera_por_pollo: '2c8c300d-6b4a-4818-9947-4987a715548f',
  cambio_de_ternera_a_pollo: '2c8c300d-6b4a-4818-9947-4987a715548f',
};
